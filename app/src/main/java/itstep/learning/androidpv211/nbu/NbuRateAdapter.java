...
public class NbuRateAdapter extends RecyclerView.Adapter<NbuRateViewHolder> {
    ...
    private List<NbuRate> nbuRates;  // не нова колекція, а посилання на ту, що в активності
...
// RecyclerView - віджет для "ледачого" відображення елементів,
// можна провести аналогію з Virtual DOM
// елементи що не є в полі зору - не переробляються
